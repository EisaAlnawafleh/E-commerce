...
const Body = () => {
  ...
  return (
    <div className="flex  flex-col gap-10 justify-center items-center  ">
      <div className="flex w-full justify-around flex-wrap gap-10 px-5 flex-row-reverse ">
        <div className="text-xl flex flex-col gap-3 ">
          <p className="text-[#b23ac8] pb-5" data-aos="fade-right">
            اكتشف مستقبل الهواتف المحمولة
          </p>
          <div className="flex flex-col gap-7">
            ...
            <div
              ...
              data-aos="fade-right"
            >
              يبدأ الابتكار من هنا
            </div>
          </div>
          <div className="text-white  text-[12px] pt-10" data-aos="fade-right">
            اكتشف أحدث الهواتف الذكية ذات الأداء القوي والتقنيات المتقدمة
            <br />
            كاميرات، وتصميم مذهل مصمم للمستقبل.
          </div>
      ...
      <div
        data-aos="fade-right"
        className=" w-[81%] h-auto mt-5 shadow-sm shadow-[#b73bcd] items-center p-10 flex-wrap gap-5 flex flex-row   justify-between rounded-2xl "
      >
