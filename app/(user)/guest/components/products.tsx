  ...
  return (
    <div className=" flex justify-center items-center flex-col">
      {opens && (
        <>
          <div
            ...
            className=" text-sm sm:text-base md:text-lg fixed inset-0 bg-black/40 flex items-center justify-center z-40 text-white"
          >
            <div
              className={`fixed top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 ${opens ? "fixed bg-[#b23ac8] p-15 rounded-2xl text-center " : "hidden"}`}
            >
      ...
      <div className="text-white font-bold text-[24px]  mt-20 ">
        وصل حديثاً <span className="text-[#b23ac8] text-4xl">.</span>
      </div>
      ...
      <div className=" mt-10 text-white flex text-center items-center justify-center gap-5 px-2 marqueee flex-wrap ">
        <motion.div
          ...
          className="bg-[#391658] max-w-55 max-h-100 rounded-2xl pb-5 shadow-[#b73bcd] shadow-sm"
        >
          <div>
            <img
          ...
          <div className=" mt-5">JD 799.00</div>
          <motion.div
            onClick={() => setOpens((prev) => !prev)}
            className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
          >
            أضف للسلة
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className=" mt-5">JD 169.00</div>
          <div
            onClick={() => setOpens((prev) => !prev)}
            className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
          >
        ...
        >
          ...
          <div className=" mt-5">JD 1199.00</div>
          <div
            onClick={() => setOpens((prev) => !prev)}
            className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
          >
        ...
        >
          ...
          <div className=" mt-5">JD 1299.00</div>
          <div
            onClick={() => setOpens((prev) => !prev)}
            className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
          >
      ...
      <div className="text-white flex flex-col justify-center text-center items-center mt-20 px-5 ">
        ...
        <div className=" mt-10 text-white flex text-center justify-center flex-wrap px=2 gap-5">
          ...
          >
            ...
            <div className=" mt-5">JD 1599.00</div>
            <div
              onClick={() => setOpens((prev) => !prev)}
              className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
            >
          ...
          >
            ...
            <div className="mt-5">JD 1399.00</div>
            <div
              onClick={() => setOpens((prev) => !prev)}
              className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
            >
          ...
          >
            ...
            <div className=" mt-5">JD 1099.00</div>
            <div
              onClick={() => setOpens((prev) => !prev)}
              className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
            >
          ...
          >
            ...
            <div className=" mt-5">JD 599.00</div>
            <div
              onClick={() => setOpens((prev) => !prev)}
              className=" rounded-2xl h-10 w-50 flex ml-2 justify-center items-center mt-8 hover:opacity-85 cursor-pointer transition duration-300 bg-[#b23ac8] border-0"
            >
